\begin{frame}<beamer:1>{Lexical Multi-Dimensional Analysis}{\citep{lmdabook}}
%\begin{figure}
\centering
...
\end{tikzpicture}
%\footnotetext{Mostly.}
%\caption{\cite[cf.][]{scott00}} 
%\label{fig:mdprocedure}
%\end{figure}
\end{frame}


\begin{frame}<beamer:0>{Corpus Linguistics: Bottom-up approach}
%\begin{figure}
\centering
%\tikzstyle{block} = [rectangle, rounded corners, text=black, text centered, draw=black, minimum height=.3in]
%\tikzstyle{block} = [rectangle, rounded corners, text=black, text centered, draw=black,font=\scriptsize, minimum height=.35in, minimum width=.65in]
