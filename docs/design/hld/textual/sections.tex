...
\begin{itemize}
    ...
    \item FR-15: Perform dimensionality reduction with Factor Analysis (EFA/Varimax);
...
\begin{itemize}
    ...
    \item FR-25: Export model artefacts (preprocessing config, feature schema, PCA/FA components).
\end{itemize}
