\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \tikzstyle{block} = [rectangle, rounded corners, text=black, anchor=north, text centered, draw=black,font=\scriptsize, minimum height=.21in,  text width=.65in]
    ...
    \end{tikzpicture}
    \caption{Lexical Multi-Dimensional Analysis \parencite{berbersardinhaLexicalMultiDimensionalAnalysis2025}}
