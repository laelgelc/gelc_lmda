\begin{frame}{Lexical MD Analysis}
    ...
    \begin{exampleblock}{\textcite[p.1]{berbersardinhaLexicalMultiDimensionalAnalysis2025}}
    ...
    \item Lexical priming and text: Lexical priming \parencite{hoeyLexicalPrimingNew2007} explains collocation as psychologically conditioned by prior exposure and sensitive to register and discourse function (p.8)
